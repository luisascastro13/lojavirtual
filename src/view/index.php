<?php
	...
	if(isset($_GET['cat'])){
		$nomeCategoria = $_GET['cat'];
		$idCategoria = CategoriaDAO::buscarPorNome($nomeCategoria);
		$idCategoria = $idCategoria[0]['id'];	
		$livrosDaCategoria = LivroDAO::buscarLivrosPorCategoria($idCategoria);
			...
			<main class="container">
				<div class="container-fluid">
					...
					<div class="px-lg-5">
						...
						<?php
							for($i = 0; $i < count($livrosDaCategoria); ++$i){
								$livro = LivroDAO::buscarPorId($livrosDaCategoria[$i]['id_livro']);
						?>
